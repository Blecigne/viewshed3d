#'  \strong{viewshed3d}: tools to compute visibility in 3D point clouds of ecosystems
#'
...
#' visibility within a single viewshed is calculated using the \code{\link{visibility}}
